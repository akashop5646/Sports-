          ...
          <div className="flex-1 overflow-y-auto pr-1 space-y-5 scrollbar-thin scrollbar-thumb-white/10">
            ...
            {friends.length > 0 && (
              <button
                onClick={() => {
                  onOpenChange(false);
                  setTimeout(() => setIsAllFriendsOpen(true), 100);
                }}
                className="w-full flex items-center justify-center gap-2 text-sm text-primary hover:text-primary/80 font-medium py-2.5 rounded-xl border border-border/30 hover:border-primary/30 bg-elevated/10 hover:bg-elevated/20 transition cursor-pointer"
              >
